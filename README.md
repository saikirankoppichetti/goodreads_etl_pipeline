...
<img src="https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/goodreads.png" align="center">

## Architecture 
![Pipeline Architecture](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/architecture.png)

Pipeline Consists of various modules:

 - [GoodReads Python Wrapper](https://github.com/saikirankoppichetti/goodreads)
 - ETL Jobs
 - Redshift Warehouse Module
 - Analytics Module 

#### Overview
Data is captured in real time from the goodreads API using the Goodreads Python wrapper (View usage - [Fetch Data Module](https://github.com/saikirankoppichetti/goodreads/blob/master/example/fetchdata.py)). The data collected from the goodreads API is stored on local disk and is timely moved to the Landing Bucket on AWS S3. ETL jobs are written in spark and scheduled in airflow to run every 10 minutes.  
...
I have written detailed instruction on how to setup Airflow using AWS CloudFormation script. Check out - [Airflow using AWS CloudFormation](https://github.com/saikirankoppichetti/Data_Engineering_Projects/blob/master/Airflow_Livy_Setup_CloudFormation.md)
...
Finally, copy the dag and plugin folder to EC2 inside airflow home directory. Also, checkout [Airflow Connection](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/Airflow_Connections.md) for setting up connection to EMR and Redshift from Airflow.
...
### Setting up Redshift
You can follow the AWS Guide to run a Redshift cluster or alternatively you can use [Redshift_Cluster_IaC.py](https://github.com/saikirankoppichetti/Data_Engineering_Projects/blob/master/Redshift_Cluster_IaC.py) Script to create cluster automatically. 
...
![Pipeline DAG](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/goodreads_dag.PNG)

DAG View:
![DAG View](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/DAG.PNG)

DAG Tree View:
![DAG Tree](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

DAG Gantt View: 
![DAG Gantt View](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/DAG_Gantt.PNG)
...
![Source Dataset Count](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/DatasetCount.PNG)


DAG Run Results:
![GoodReads DAG Run](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

Data Loaded to Warehouse:
![GoodReads Warehouse Count](https://github.com/saikirankoppichetti/goodreads_etl_pipeline/blob/master/docs/images/WarehouseCount.PNG)
...
## Maintainer
This project is maintained by Sai Kiran Koppichetti. Sai is an AI/ML Engineer with over 5 years of experience across machine learning, data science, and analytics. He specializes in building end-to-end data ingestion pipelines, RAG systems, and scalable cloud architectures on AWS.
